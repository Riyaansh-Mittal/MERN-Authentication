...
const Profile = () => {
  ...
  const handleChange = (e) => {
    ...
    // remember this syntax to add info to useState with []
  }
  const handleSubmit = async(e) => {
    ...
    try{
      ...
      // setFormData({ ...data.user, profilePicture: data.user.profilePicture });
    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <p className="test-sm self-center">
          {imageError ? (
            <span className="txt-ted-700"> Error uploading 
        ...
        disabled:opcaity-80">{loading ? 'Loading...': 'Update'}</button>
      </form>
